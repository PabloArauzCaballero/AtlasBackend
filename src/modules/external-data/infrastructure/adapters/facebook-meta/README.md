...
# src/modules/external-data/infrastructure/adapters/facebook-meta
...
|---|---|
| [`facebook-meta.adapter.ts`](./facebook-meta.adapter.ts) | Artefacto de soporte específico de esta carpeta. |
