...
# src/modules/external-data/infrastructure/adapters/telco-generic
...
|---|---|
| [`telco-generic.adapter.ts`](./telco-generic.adapter.ts) | Artefacto de soporte específico de esta carpeta. |
