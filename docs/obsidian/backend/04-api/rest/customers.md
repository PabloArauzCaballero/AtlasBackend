...
|---|---|---|---|---|---|---|
| `GET` | `/customers/:customerId/me` | 🔒 JWT | `...` | — | 200, 400, 403, 404 | Perfil resumido del cliente ("mi perfil") |
...
- [`src/modules/customers/customers.controller.ts`](../../../../src/modules/customers/customers.controller.ts)
