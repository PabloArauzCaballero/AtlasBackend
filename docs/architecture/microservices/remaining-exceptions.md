...
## Pendientes del piloto tras desplegarlo (2026-09-13)

| Pendiente                                            | Por qué no se ha hecho                                                                                                                                                                                                         | Qué desbloquea              |
| ---------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------- |
| Encender `EVENTS_RELAY_V2_ENABLED` en otros entornos | hecho y observado en dev (2026-09-13); en cualquier otro entorno hay que encenderla antes de cortar allí                                                                                                                       | —                           |
| Ensayo del corte en staging                          | hecho de punta a punta EN DEV el 2026-09-13 (`docs/testing/evidence/pilot-cutover-2026-09-13.md`): corte, entrega por el piloto y reversión. Sin carga y con base compartida; repetirlo en staging con tráfico sigue pendiente | protocolo de carga (AT-054) |
| Autorización del despliegue del piloto               | responsables, ventana y criterio de cancelación los acuerda una persona                                                                                                                                                        | —                           |

**Código muerto detectado al investigar:** `RuntimeHardeningService.listPendingOutbox` y `markOutboxProcessed` no tienen
ningún llamador en `src` (sólo pruebas unitarias). No son el drenador de la telemetría —ése es el job `process_outbox`, que
consulta por SQL y excluye los códigos del catálogo—, así que sobran: o se cablean para algo, o se retiran.
