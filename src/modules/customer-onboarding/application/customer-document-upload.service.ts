...
import {
  CREDIT_ELIGIBLE_STATUS,
  EDITABLE_ONBOARDING_STATUSES,
  normalizeLifecycleStatus,
} from '../../customers/customer-lifecycle.constants.js';
...
export class CustomerDocumentUploadService {
  ...
  async createUploadUrl(input: {
    ...
    const uploadAllowed = EDITABLE_ONBOARDING_STATUSES.includes(status) || (isCreditStatementUpload && status === CREDIT_ELIGIBLE_STATUS);
    if (!uploadAllowed) {
