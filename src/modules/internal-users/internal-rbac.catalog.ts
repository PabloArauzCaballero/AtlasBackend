...
import { CREDIT_PERMISSION_SEEDS } from './internal-rbac.catalog.credit.js';

/**
 * La lista entera llegó a 500 líneas y no tiene techo: crece con cada pantalla nueva. Se reparte en
 * lo que se opera del sistema, quién entra, qué se ve del dato, quién abre un expediente y quién
 * puede anular una tasa del ciclo de crédito — y se vuelve a juntar aquí, para que nadie tenga que
 * saber en cuál de los grupos cayó un permiso.
 */
