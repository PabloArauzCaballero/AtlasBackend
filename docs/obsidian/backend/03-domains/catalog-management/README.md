...
# docs/obsidian/backend/03-domains/catalog-management

## Por qué existe

- **Negocio:** esta carpeta conserva decisiones y contratos para reducir dependencia de conocimiento tácito.
- **Sistema:** esta carpeta documenta catalog-management como fuente versionada para desarrollo y operación.
