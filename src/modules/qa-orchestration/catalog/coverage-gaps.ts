...
export const COVERAGE_GAPS: Record<string, GapReason> = {
  ...
  'lifecycle.verification_channels': 'RECIPE_PENDING',
  'lifecycle.survey_catalog': 'RECIPE_PENDING',
  'lifecycle.session_start': 'RECIPE_PENDING',
  'lifecycle.contact_methods': 'RECIPE_PENDING',
  'lifecycle.contact_request': 'RECIPE_PENDING',
  'lifecycle.contact_submit': 'NEEDS_OTP_SINK',
  'lifecycle.whatsapp_start': 'RECIPE_PENDING',
  'lifecycle.whatsapp_confirm': 'NEEDS_OTP_SINK',
  'lifecycle.documents_upload_url': 'NEEDS_SYNTHETIC_UPLOAD',
  'lifecycle.identity_package': 'NEEDS_SYNTHETIC_UPLOAD',
  'lifecycle.identity_verification': 'NEEDS_SYNTHETIC_UPLOAD',
  'lifecycle.evidence_documents': 'NEEDS_SYNTHETIC_UPLOAD',
  'lifecycle.address_package': 'RECIPE_PENDING',
  'lifecycle.location_pings': 'RECIPE_PENDING',
  'lifecycle.address_book': 'RECIPE_PENDING',
  'lifecycle.financial_profile': 'RECIPE_PENDING',
  'lifecycle.bank_statement': 'NEEDS_SYNTHETIC_UPLOAD',
  'lifecycle.bank_statement_latest': 'NEEDS_SYNTHETIC_UPLOAD',
  'lifecycle.reference_contacts_add': 'RECIPE_PENDING',
  'lifecycle.reference_contacts_list': 'RECIPE_PENDING',
  'lifecycle.contacts_snapshot': 'RECIPE_PENDING',
  'lifecycle.survey_get': 'RECIPE_PENDING',
  'lifecycle.survey_put': 'RECIPE_PENDING',
  'lifecycle.consent_decisions': 'RECIPE_PENDING',
  'lifecycle.external_features': 'RECIPE_PENDING',
  'lifecycle.submit': 'RECIPE_PENDING',
  'lifecycle.workflow_progress': 'RECIPE_PENDING',
  ...
  'lifecycle.credit_line': 'RECIPE_PENDING',
  'lifecycle.credit_line_history': 'RECIPE_PENDING',
  'lifecycle.loans': 'NEEDS_LOAN_FIXTURE',
  'lifecycle.payment_calendar': 'NEEDS_LOAN_FIXTURE',
  'lifecycle.spending_by_category': 'RECIPE_PENDING',
  ...
  'lifecycle.device_token': 'RECIPE_PENDING',
  'lifecycle.notification_preferences': 'RECIPE_PENDING',
  'lifecycle.notifications': 'RECIPE_PENDING',
  'lifecycle.notification_read': 'RECIPE_PENDING',
  'lifecycle.telemetry': 'RECIPE_PENDING',
  'lifecycle.session_heartbeat': 'RECIPE_PENDING',
  'lifecycle.data_subject_request': 'RECIPE_PENDING',
  'lifecycle.session_end': 'RECIPE_PENDING',
  'lifecycle.logout': 'RECIPE_PENDING',
