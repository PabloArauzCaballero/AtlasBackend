...
@Table({ tableName: 'customer_contact_methods', schema: atlasSchemaFor('customer_contact_methods'), timestamps: false })
export class CustomerContactMethodModel extends Model {
  ...
  @Column({ field: 'contact_type', type: DataType.STRING(30) })
  ...
  @Column({ field: 'contact_value_encrypted', type: DataType.BLOB })
  ...
  @Column({ field: 'label', type: DataType.STRING(40) })
