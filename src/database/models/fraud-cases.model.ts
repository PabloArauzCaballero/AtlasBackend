...
@Table({ tableName: 'fraud_cases', schema: atlasSchemaFor('fraud_cases'), timestamps: false })
export class FraudCaseModel extends Model {
  ...
  @Column({ field: 'escalated_from_review_case_id', type: DataType.BIGINT })
  declare escalatedFromReviewCaseId: string | null;
  ...
  @Column({ field: 'linked_customers_json', type: DataType.JSONB })
  declare linkedCustomersJson: Record<string, unknown> | null;

  @Column({ field: 'linked_sessions_json', type: DataType.JSONB })
  declare linkedSessionsJson: Record<string, unknown> | null;

  @Column({ field: 'linked_devices_json', type: DataType.JSONB })
  declare linkedDevicesJson: Record<string, unknown> | null;
