...
describe('EndpointDiscoveryService security metadata', () => {
  it('distingue métodos públicos y protegidos dentro del mismo controller', () => {
    const classifier = {
    ...
    const endpoints = service.scanControllers();
  ...
  it('resuelve conjuntos reales de roles de Systems Ops', () => {
