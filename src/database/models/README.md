...
| [`knowledge-article-versions.model.ts`](./knowledge-article-versions.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`knowledge-articles.model.ts`](./knowledge-articles.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
...
| [`support-agent-profiles.model.ts`](./support-agent-profiles.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-agent-skills.model.ts`](./support-agent-skills.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-assignments.model.ts`](./support-assignments.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-attachments.model.ts`](./support-attachments.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-canned-responses.model.ts`](./support-canned-responses.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-case-categories.model.ts`](./support-case-categories.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-case-events.model.ts`](./support-case-events.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-case-feedback.model.ts`](./support-case-feedback.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-case-links.model.ts`](./support-case-links.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-case-references.model.ts`](./support-case-references.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-cases.model.ts`](./support-cases.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-channel-participants.model.ts`](./support-channel-participants.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-channels.model.ts`](./support-channels.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-message-relations.model.ts`](./support-message-relations.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-messages.model.ts`](./support-messages.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-queues.model.ts`](./support-queues.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-resolutions.model.ts`](./support-resolutions.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-sla-clocks.model.ts`](./support-sla-clocks.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
| [`support-sla-policies.model.ts`](./support-sla-policies.model.ts) | Modelo ORM: mapea una tabla y su contrato tipado. |
