...
# docs/obsidian/backend/03-domains/customer-telemetry

## Por qué existe

- **Negocio:** esta carpeta conserva decisiones y contratos para reducir dependencia de conocimiento tácito.
- **Sistema:** esta carpeta documenta customer-telemetry como fuente versionada para desarrollo y operación.
