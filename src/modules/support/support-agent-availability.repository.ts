/**
 * @file Quién está libre para atender, y la reserva de su hueco.
...
/**
 * Sale de `SupportAgentRepository` porque es la parte que compite: reservar un agente es un
 * `SELECT ... FOR UPDATE` con reintento, no una lectura de ficha. Mezclada con el alta y la baja de
 * perfiles tapaba cuál de las dos cosas se estaba leyendo, y juntas pasaban del límite de
 * `check:file-size`.
 */
@Injectable()
export class SupportAgentAvailabilityRepository {
  constructor(
