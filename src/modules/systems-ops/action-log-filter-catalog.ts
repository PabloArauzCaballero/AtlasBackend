...
const CAMPOS_FIJOS: ActionLogFilterField[] = [
  ...
  { name: 'statusCode', label: 'Código de respuesta', source: 'SCHEMA', control: 'number', options: [], help: 'Código HTTP exacto (100–599).' },
  ...
  { name: 'requestId', label: 'Request ID', source: 'SCHEMA', control: 'text', options: [], help: 'Identificador técnico de una petición concreta.' },
  {
    name: 'correlationId',
