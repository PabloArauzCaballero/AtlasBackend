...
orm_model: "RiskRulesetVersionModel"
tags:
  - "backend"
  - "data"
  - "entity"
  - "schema/risk"
source_files:
  - "src/database/models/risk-ruleset-versions.model.ts"
aliases:
...
- **Tabla física:** `risk.risk_ruleset_versions`
- **Modelo ORM:** `RiskRulesetVersionModel`
- **Dominio:** Riesgo y features → [[risk-schema]]
- **Atributos:** 10 · **FK salientes:** 1 · **Referencias entrantes:** 2
...
| `rulesetCode` | `ruleset_code` | string \| null | STRING(80) | No | — | — |
...
|---|---|---|
| [[risk_policy_rules]] | `ruleset_version_id` | 0..N opcional |
| [[risk_assessment_runs]] | `risk_ruleset_version_id` | 0..N opcional |
