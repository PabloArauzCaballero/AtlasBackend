 ...
 * @system traduce el contrato OpenAPI al formato abreviado que guarda el catálogo de endpoints.
 */
import type { OpenAPIObject } from '@nestjs/swagger';

/**
 * Traduce un esquema de OpenAPI al formato ABREVIADO del catálogo: `{ campo: 'tipo|required' }`.
 *
 * Ése es el formato que ya usan las semillas manuales y el que lee el generador de datos de prueba
 * del portal. Se conserva a propósito en lugar de guardar el JSON Schema entero: el catálogo
