...
# src/modules/external-data/infrastructure/adapters/infocenter
...
|---|---|
| [`infocenter.adapter.ts`](./infocenter.adapter.ts) | Artefacto de soporte específico de esta carpeta. |
