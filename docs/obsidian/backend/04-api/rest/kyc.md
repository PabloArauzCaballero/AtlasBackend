...
|---|---|---|---|---|---|---|
| `POST` | `/kyc/segip/verify` | 🔒 JWT | `customer`<br>`internal_operator`<br>`risk_analyst`<br>`compliance_analyst`<br>`fraud_analyst`<br>`admin`<br>`platform_admin`<br>`system` | — | 200, 403 | Verificar identidad contra SEGIP |
