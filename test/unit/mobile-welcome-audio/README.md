...
# test/unit/mobile-welcome-audio
...
|---|---|
| [`mobile-welcome-audio.service.spec.ts`](./mobile-welcome-audio.service.spec.ts) | Prueba automatizada: fija comportamiento y evita regresiones. |
