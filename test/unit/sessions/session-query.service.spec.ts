...
describe('SessionQueryService', () => {
  function buildService() {
    const sessionsRepository = {
      ...
      findSessionGpsObservations: jest.fn(async (..._args: unknown[]) => []),
      findSessionDeviceSnapshots: jest.fn(async (..._args: unknown[]) => []),
      findSessionPermissionEvents: jest.fn(async (..._args: unknown[]) => []),
      findSessionAuthEvents: jest.fn(async (..._args: unknown[]) => []),
      findSessionIpReputation: jest.fn(async (..._args: unknown[]) => []),
      findSessionSimObservations: jest.fn(async (..._args: unknown[]) => []),
      findDeviceRiskEvents: jest.fn(async (..._args: unknown[]) => []),
      findSessionCustomerActions: jest.fn(async (..._args: unknown[]) => []),
      findSessionCustomerObservations: jest.fn(async (..._args: unknown[]) => []),
      findSessionAudits: jest.fn(async (..._args: unknown[]) => []),
    };
