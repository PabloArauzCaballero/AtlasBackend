...
FROM pg_tables
WHERE schemaname IN ('iam','credit','customer','privacy','telemetry','catalog','risk','case_management','audit','integrations','messaging','platform_ops','partner','support','expedientes')
GROUP BY schemaname
ORDER BY schemaname;
